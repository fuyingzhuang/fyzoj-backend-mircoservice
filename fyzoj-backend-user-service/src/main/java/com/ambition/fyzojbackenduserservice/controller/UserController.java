package com.ambition.fyzojbackenduserservice.controller;

import com.ambition.fyzojbackendcommon.annotation.AuthCheck;
...
import com.ambition.fyzojbackendcommon.constant.UserConstant;
import com.ambition.fyzojbackendcommon.exception.BusinessException;
import com.ambition.fyzojbackendcommon.exception.ThrowUtils;
import com.ambition.fyzojbackendmodel.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        if (StringUtils.isAnyBlank(userAccount, userPassword, checkPassword, userName, avatarUrl)) {
            return null;
        }
     ...
     * 更新个人信息
     *
     * @param userUpdateMyRequest 用户信息
     * @param request             HttpServletRequest
     * @return BaseResponse
     */
